...
### Registry Configuration (flattened from AzAPI properties)
...
- `metadataSearch`: Control metadata search indexing
- `networkRuleBypassOptions`: Configure trusted service access
