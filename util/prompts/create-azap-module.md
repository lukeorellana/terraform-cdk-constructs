...
Can you make the src/azure-functionapp into an AzAPI construct instead of using the AzureRM provider? Also make sure that the .spec test runs, successfully. You may updated the .integ test but dont run it. Also no need to run build.
