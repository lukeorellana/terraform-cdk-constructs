...
export interface VirtualnetworkConfig extends TerraformModuleUserConfig {
  /**
...
- `enable`: Enables or disables the DDoS Protection Plan on the Virtual Network. (Required)
  ...
  */
  readonly ddosProtectionPlan?: any;
  /**
...
- `reverse_use_remote_gateways`: (Optional) If you have selected `create_reverse_peering`, enables the use of remote gateways for the virtual networks. Defaults to false.
  ...
  */
  ...
  /**
  * (Optional) Subscription ID passed in by an external process.  If this is not supplied, then the configuration either needs to include the subscription ID, or needs to be supplied properties to create the subscription.
  */
...
/**
* Defines an Virtualnetwork based on a Terraform module
*
* Docs at Terraform Registry: {@link https://registry.terraform.io/modules/Azure/avm-res-network-virtualnetwork/azurerm/0.8.1 Azure/avm-res-network-virtualnetwork/azurerm}
*/
export class Virtualnetwork extends TerraformModule {
  ...
  public constructor(scope: Construct, id: string, config: VirtualnetworkConfig) {
    ...
    this.bgpCommunity = config.bgpCommunity;
    this.ddosProtectionPlan = config.ddosProtectionPlan;
    this.diagnosticSettings = config.diagnosticSettings;
    this.dnsServers = config.dnsServers;
    this.enableTelemetry = config.enableTelemetry;
    this.enableVmProtection = config.enableVmProtection;
    this.encryption = config.encryption;
    this.extendedLocation = config.extendedLocation;
    this.flowTimeoutInMinutes = config.flowTimeoutInMinutes;
    this.location = config.location;
    this.lock = config.lock;
    this.name = config.name;
    this.peerings = config.peerings;
  ...
  public get addressSpace(): string[] {
    return this.inputs['address_space'] as string[];
  }
  public set addressSpace(value: string[]) {
    this.inputs['address_space'] = value;
  }
  public get bgpCommunity(): string | undefined {
    return this.inputs['bgp_community'] as string | undefined;
  }
  public set bgpCommunity(value: string | undefined) {
    this.inputs['bgp_community'] = value;
  }
  public get ddosProtectionPlan(): any | undefined {
    return this.inputs['ddos_protection_plan'] as any | undefined;
  }
  public set ddosProtectionPlan(value: any | undefined) {
    this.inputs['ddos_protection_plan'] = value;
  }
  ...
  public get dnsServers(): any | undefined {
    return this.inputs['dns_servers'] as any | undefined;
  }
  public set dnsServers(value: any | undefined) {
    this.inputs['dns_servers'] = value;
  }
  ...
  public get enableVmProtection(): boolean | undefined {
    return this.inputs['enable_vm_protection'] as boolean | undefined;
  }
  public set enableVmProtection(value: boolean | undefined) {
    this.inputs['enable_vm_protection'] = value;
  }
  public get encryption(): any | undefined {
    return this.inputs['encryption'] as any | undefined;
  }
  public set encryption(value: any | undefined) {
    this.inputs['encryption'] = value;
  }
  public get extendedLocation(): any | undefined {
    return this.inputs['extended_location'] as any | undefined;
  }
  public set extendedLocation(value: any | undefined) {
    this.inputs['extended_location'] = value;
  }
  public get flowTimeoutInMinutes(): number | undefined {
    return this.inputs['flow_timeout_in_minutes'] as number | undefined;
  }
  public set flowTimeoutInMinutes(value: number | undefined) {
    this.inputs['flow_timeout_in_minutes'] = value;
  }
  ...
  public get peerings(): any | undefined {
    return this.inputs['peerings'] as any | undefined;
  }
  public set peerings(value: any | undefined) {
    this.inputs['peerings'] = value;
  }
  ...
  public get subnets(): any | undefined {
    return this.inputs['subnets'] as any | undefined;
  }
  public set subnets(value: any | undefined) {
    this.inputs['subnets'] = value;
  }
  public get subscriptionId(): string | undefined {
    return this.inputs['subscription_id'] as string | undefined;
  }
  public set subscriptionId(value: string | undefined) {
    this.inputs['subscription_id'] = value;
  }
  ...
  public get peeringsOutput() {
    return this.getString('peerings')
  }
  ...
  public get subnetsOutput() {
    return this.getString('subnets')
  }
